...
class partylegaldisclosure extends StatefulWidget {
  const partylegaldisclosure({super.key});

  @override
  State<partylegaldisclosure> createState() => _partylegaldisclosureState();
}

class _partylegaldisclosureState extends State<partylegaldisclosure> {
  @override
  void initState() {
    super.initState();
  }
